...
**Windows**
- Скачайте `angry-box-0.5.2-windows-amd64.zip` или `.exe`
...
|-------------------|------------------------|--------------------------------------------|---------------|
| Keenetic (Entware)| `aarch64-3.10`         | `angry-box_0.5.2_aarch64-3.10.ipk`         | `/opt/bin`    |
| Keenetic          | `mipsel_24kc`          | `angry-box_0.5.2_mipsel_24kc.ipk`          | `/opt/bin`    |
| OpenWRT           | `aarch64_cortex-a53`   | `angry-box_0.5.2_aarch64_cortex-a53.ipk`   | `/usr/bin`    |
| OpenWRT           | `mips_24kc`            | `angry-box_0.5.2_mips_24kc.ipk`            | `/usr/bin`    |
...
Разрешено использование только в **личных, некоммерческих, образовательных и научных целях.**  
**Любое коммерческое использование запрещено.**

ПРОГРАММНОЕ ОБЕСПЕЧЕНИЕ ПРЕДОСТАВЛЯЕТСЯ «КАК ЕСТЬ», БЕЗ КАКИХ-ЛИБО ГАРАНТИЙ. Автор не несёт ответственности за любой ущерб, возникший в результате использования данного ПО.
...
**Текущая версия:** 0.5.2 — исправленная упаковка для роутеров, поддержка Windows и улучшенная документация.