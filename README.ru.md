...
| Платформа         | Архитектура            | Пример пакета                              |
|-------------------|------------------------|--------------------------------------------|
...
# Продакшн-сборка (всё вшито в бинарник)
make build
...
**Текущая версия:** 0.5.2 — веб-интерфейс (HTMX + Tailwind + DaisyUI), dev/prod режим, юридические уведомления.